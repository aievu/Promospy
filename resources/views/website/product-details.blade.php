@vite(['resources/css/website/product-details.css', 'resources/js/website/product-details.js'])
                        ...
                        @can('view', $product)
                            <div class="product-owner-actions">
                                <div x-data="{ open: false }">
                                    <div>
                                        <button
                                            class="product-card-actions button edit"
                                            @click="open = true"
                                        >
                                    ...
                                    <x-modal title="Edit product">
                                        <form method="POST" action="{{ route('product-details.update', $product->id )}}" class="space-y-4">
                                            @csrf
                                            @method('PUT')
                            ...
                            <form action="{{ route('my-products.delete', $product) }}" method="POST">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="product-owner-actions button">
